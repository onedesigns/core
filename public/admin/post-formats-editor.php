...
add_action( 'enlightenment_before_theme_settings', 'enlightenment_simulate_post_format' );

function enlightenment_simulate_post_format( $tab ) {
...
function enlightenment_post_formats_available_functions( $hooks ) {
	...
	elseif( 'status' == $post_format )
		$functions[] = 'enlightenment_author_avatar';
