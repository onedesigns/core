...
add_action( 'enlightenment_before_page_builder', 'enlightenment_simulate_query' );
...
function enlightenment_page_builder_form( $post ) {
	...
	enlightenment_checkbox( array(
		...
		'label' => sprintf( __( 'Use global template hooks for %1$s', 'enlightenment' ), $post->post_type ),
	) );
