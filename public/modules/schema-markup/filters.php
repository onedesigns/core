...
function enlightenment_schema_markup_site_title_args( $args ) {
	$args['container_extra_atts'] .= ' itemprop="headline"';
	return $args;
}
add_filter( 'enlightenment_site_title_args', 'enlightenment_schema_markup_site_title_args' );

function enlightenment_schema_markup_site_description_args( $args ) {
	$args['container_extra_atts'] .= ' itemprop="description"';
	return $args;
}
add_filter( 'enlightenment_site_description_args', 'enlightenment_schema_markup_site_description_args' );
...
add_filter( 'enlightenment_page_content_extra_atts_args', 'enlightenment_schema_markup_content_extra_atts_args' );

function enlightenment_schema_markup_the_loop_args( $args ) {
	$args['entry_extra_atts'] .= ' itemscope itemprop="blogPost" itemtype="http://schema.org/' . ( 'post' == get_post_type() ? 'BlogPosting' : 'Article' ) . '"';
	return $args;
}
add_filter( 'enlightenment_the_loop_args', 'enlightenment_schema_markup_the_loop_args' );

function enlightenment_schema_markup_entry_title_args( $args ) {
	$args['container_extra_atts'] .= ' itemprop="headline"';
	return $args;
}
add_filter( 'enlightenment_entry_title_args', 'enlightenment_schema_markup_entry_title_args' );
...
function enlightenment_schema_markup_post_excerpt_args( $args ) {
	$args['container_extra_atts'] .= ' itemprop="text"';
	return $args;
}
add_filter( 'enlightenment_post_excerpt_args', 'enlightenment_schema_markup_post_excerpt_args' );

function enlightenment_schema_markup_post_content_args( $args ) {
	$args['container_extra_atts'] .= ' itemprop="text"';
	return $args;
}
add_filter( 'enlightenment_post_content_args', 'enlightenment_schema_markup_post_content_args' );
...
function enlightenment_site_footer_extra_atts_args( $args ) {
	$args['atts'] .= ' itemscope itemtype="http://schema.org/WPFooter"';
	return $args;
}
add_filter( 'enlightenment_site_footer_extra_atts_args', 'enlightenment_site_footer_extra_atts_args' );
